...
/**
 * Lazy-loaded ReviewDetailPage component.
 * This enables code-splitting so react-diff-view and other heavy
 * dependencies are only loaded when the user navigates to a review.
 */
export const LazyReviewDetailPage = lazy(() =>
  import('./ReviewDetailPage').then((module) => ({
 ...
 */
export function ReviewDetailPageWithSuspense() {
  return (
    <Suspense fallback={<ReviewDetailPageSkeleton />}>
      <LazyReviewDetailPage />
    </Suspense>
  );
}
